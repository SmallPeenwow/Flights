...
namespace Flights.Controllers
{
    ...
    public class FlightController : ControllerBase
    {
        ...
        {
           new (
                Guid.NewGuid(), "American Airlines",
           ...
           new (
                Guid.NewGuid(), "ABA Air",
                random.Next(90, 5000).ToString(),
                new TimePlaceRm("Praha Ruzyle", DateTime.Now.AddHours(random.Next(1, 55))),
                new TimePlaceRm("Paris", DateTime.Now.AddHours(random.Next(4, 58))),
                random.Next(1, 853)
               ),
           new (
                Guid.NewGuid(), "AB Corporate Aviation",
                random.Next(90, 5000).ToString(),
